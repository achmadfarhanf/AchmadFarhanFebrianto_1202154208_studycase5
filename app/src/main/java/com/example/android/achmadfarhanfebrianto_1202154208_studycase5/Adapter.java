package com.example.android.achmadfarhanfebrianto_1202154208_studycase5;
...
public class Adapter extends RecyclerView.Adapter<Adapter.holder> {
    ...
    public void deleteData(int i){
        ...
        list.remove(i);
        //memberi notifikasi item yang berada di remove
        notifyItemRemoved(i);
        notifyItemRangeChanged(i, list.size());
    }

    class holder extends RecyclerView.ViewHolder{
        //deklarasi variable yang akan digunakan nantinya
